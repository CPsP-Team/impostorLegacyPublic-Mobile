...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option(Lang.str('opt_mobilecontrols', 'Mobile Controls'), Lang.str('opt_mobilecontrols_desc', 'Changes the mobile note controls style.'), 'mobileControlMode', 'string', 'Hitbox', [Lang.str('choice_mobilecontrols_hitboxmode', 'Hitbox Mode'), Lang.str('choice_mobilecontrols_vanillamode', 'Vanilla Mode')], ['Hitbox', 'Vanilla']);
		addOption(option);
